define(['dart_sdk', 'packages/angular_components/model/observable/observable', 'packages/angular_components/utils/angular/properties/properties', 'packages/angular_components/model/ui/accepts_width', 'packages/angular_components/model/menu/menu'], function(dart_sdk, observable, properties, accepts_width, menu) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["menu_popup_wrapper.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;IAgBY;;;;;;mBAIK,KAAK;AAClB,yBAAI,eAAS,MAAM,EAAI,KAAK,GAAE;AAC9B,qBAAS,MAAM,GAAG,8CAAO,CAAC,KAAK;IACjC;;YAEuB,gBAAS,MAAM;;;YAID,gBAAS,OAAO;;;cAOpC,SAAI;;6BAAW,YAAM;;cAK5B,GAAG;AACX,kBAAM,GAAG,6CAAM,CAAC,GAAG,iBAAgB;AACnC,YAAc,AAAK,aAAZ,YAAM,KAAI,KAAY,aAAP,YAAM,KAAI;IAClC;IAQS;;;;;;;;IApCC,WAAI;IAcR,eAAS,OAAG,iCAAyB,CAAC;IAgBxC,YAAM,GAAG;IAMJ,wBAAkB;EAC7B","file":"menu_popup_wrapper.ddc.js"}');
  // Exports:
  return {
