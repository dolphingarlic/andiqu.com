define(['dart_sdk', 'packages/angular_components/button_decorator/button_decorator'], function(dart_sdk, button_decorator) {
  ...
  (material_button__material_button_base.MaterialButtonBase.new = function(element, role) {
    this[_focused] = false;
    this[_clickFocused] = false;
    this[_isMouseDown] = false;
    this[raised] = false;
    material_button__material_button_base.MaterialButtonBase.__proto__.new.call(this, element, role);
