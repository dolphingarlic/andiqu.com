define(['dart_sdk', 'packages/angular_components/model/ui/highlighted_text_model'], function(dart_sdk, highlighted_text_model) {
  ...
  model__ui__highlight_assistant.HighlightAssistant = class HighlightAssistant extends core.Object {
    ...
    highlightOption(_lastQuery, item, itemRenderer) {
      ...
      if (value == null) {
        value = this[_optionHighlighter] != null ? this[_optionHighlighter](_lastQuery, item) : this[_textHighlighter].highlight(itemRenderer(item), _lastQuery[$split](model__ui__highlight_assistant.HighlightAssistant._separatorRegex));
  ...
  dart.setMethodSignature(model__ui__highlight_assistant.HighlightAssistant, () => ({
    ...
    highlightOption: dart.fnType(core.List$(model__ui__highlighted_text_model.HighlightedTextSegment), [core.String, dart.dynamic, dart.fnType(core.String, [dart.dynamic])])
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["highlight_assistant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;cAqB0C,uBAAiB;uDACrD,qDAAe,wBAAuB,2BAAqB;IAAC;oBAa5D,UAAiB,EAAE,IAAY,EAAE,YAAyB;AAC5D,cAA2B,qBAAe,QAAC,UAAU;UAAjD,mCAAuB,qBAAe,QAAC,UAAU,EAAM;AAC3D,UAAI,QAAQ,oBAAoB,QAAC,IAAI;AACrC,UAAI,KAAK,IAAI,MAAM;AACjB,aAAK,GAAI,wBAAkB,IAAI,OACzB,wBAAkB,CAAC,UAAU,EAAE,IAAI,IACnC,sBAAgB,UAAU,CACxB,YAAY,CAAC,IAAI,GAAG,UAAU,QAAM,CAAC,iEAAe;AAC5D,4BAAoB,QAAC,IAAI,EAAI,KAAK;;AAEpC,YAAO,MAAK;IACd;;;QAhBiB;QAAwB,4FAAuB;IAlB1D,qBAAe,GACjB;IAKY,uBAAiB;IAa3B,wBAAkB,GAAG,iBAAiB;IACtC,2BAAqB,GAAG,oBAAoB;;;;;;;;;;;;;;;;;;;MAvB9B,iEAAe;YAAG,gBAAM,CAAC","file":"highlight_assistant.ddc.js"}');
  // Exports:
  return {
