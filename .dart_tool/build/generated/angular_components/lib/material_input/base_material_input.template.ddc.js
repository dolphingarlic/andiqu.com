define(['dart_sdk', 'packages/angular_components/material_input/deferred_validator.template', 'packages/angular/angular.template', 'packages/angular_components/focus/focus.template', 'packages/angular_components/forms/error_renderer.template', 'packages/angular_components/interfaces/has_disabled.template', 'packages/angular_components/mixins/focusable_mixin.template', 'packages/angular_components/utils/disposer/disposer.template', 'packages/angular_forms/angular_forms.template'], function(dart_sdk, deferred_validator, angular, focus, error_renderer, has_disabled, focusable_mixin, disposer, angular_forms) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["base_material_input.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;MA6BI,uDAAQ;YAAG;;;;;AAEb,kBAAI,uDAAQ,GAAE;AACZ;;AAEF,8DAAW;AAEX,IAAM,2DAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,qCAAa;AACnB,IAAM,8CAAa;AACnB,IAAM,8CAAa;AACnB,IAAM,iDAAa;AACnB,IAAM,gDAAa;AACnB,IAAM,kDAAa;AACnB,IAAM,sCAAa;EACrB","file":"base_material_input.template.ddc.js"}');
  // Exports:
  return {
