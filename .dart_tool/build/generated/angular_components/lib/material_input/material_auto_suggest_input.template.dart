...
import 'package:angular_components/model/selection/string_selection_options.template.dart' as _ref28;
import 'package:angular_components/model/ui/has_factory.template.dart' as _ref29;
import 'package:angular_components/model/ui/highlight_provider.template.dart' as _ref30;
import 'package:angular_components/model/ui/template_support.template.dart' as _ref31;
import 'package:angular_components/stop_propagation/stop_propagation.template.dart' as _ref32;
import 'package:angular_components/utils/angular/properties/properties.template.dart' as _ref33;
import 'package:angular_components/utils/async/async.template.dart' as _ref34;
import 'package:angular_components/utils/id_generator/id_generator.template.dart' as _ref35;
import 'package:angular_forms/angular_forms.template.dart' as _ref36;
...
import '../interfaces/has_disabled.dart' as import36;
...
import '../material_icon/material_icon.template.dart' as import43;
import '../button_decorator/button_decorator.template.dart' as import44;
import '../material_icon/material_icon.dart' as import45;
import '../src/material_tooltip/tooltip.dart' as import46;
import '../stop_propagation/stop_propagation.dart' as import47;
import '../material_tooltip/module.dart' as import48;
import '../src/material_tooltip/tooltip_controller.dart' as import49;
import '../utils/disposer/disposer.dart' as import50;
import '../button_decorator/button_decorator.dart' as import51;
import '../focus/focus_trap.template.dart' as import52;
import '../focus/focus_trap.dart' as import53;
import '../material_spinner/material_spinner.template.dart' as import54;
import '../material_spinner/material_spinner.dart' as import55;
import '../material_list/material_list.template.dart' as import56;
import '../material_list/material_list.dart' as import57;
import 'package:angular/src/common/directives/ng_for.dart' as import58;
import '../model/selection/selection_options.dart' as import59;
import '../dynamic_component/dynamic_component.template.dart' as import60;
import '../dynamic_component/dynamic_component.dart' as import61;
import 'package:angular/src/core/linker/dynamic_component_loader.dart' as import62;
import '../material_select/material_select_dropdown_item.template.dart' as import63;
import '../material_select/material_select_dropdown_item.dart' as import64;
import '../material_select/activation_handler.dart' as import65;
import '../utils/id_generator/id_generator.dart' as import66;
import '../model/selection/selection_container.dart' as import67;
import '../model/ui/has_renderer.dart' as import68;
import '../model/a11y/active_item_directive.template.dart' as import69;
import '../model/a11y/active_item_directive.dart' as import70;
import '../laminate/components/modal/modal.dart' as import71;
import '../model/ui/highlight_provider.dart' as import72;
import '../model/ui/has_factory.dart' as import73;
...
class ViewMaterialAutoSuggestInputComponent0 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    ...
    _PopupSourceDirective_0_14 = import10.PopupSourceDirective(parentView.injectorGet(import23.DomPopupSourceFactory, viewData.parentIndex), _el_0, _ReferenceDirective_0_12, _Focusable_0_13, null);
    ...
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialAutoSuggestInputComponent1);
    ...
    _MaterialPopupComponent_3_8 = import14.MaterialPopupComponent(parentView.injectorGet(import25.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import14.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import26.NgZone, viewData.parentIndex), parentView.injectorGet(import27.OverlayService, viewData.parentIndex), parentView.injectorGet(import28.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import29.OpaqueToken<List<import31.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import29.OpaqueToken('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import32.PopupSizeProvider, viewData.parentIndex, null), _compView_3.ref, _appEl_3, ElementRef(_el_3));
    _el_4 = doc.createElement('div');
    createAttr(_el_4, 'header', '');
    createAttr(_el_4, 'keyboardOnlyFocusIndicator', '');
    _el_4.tabIndex = -1;
    addShimC(_el_4);
    _KeyboardOnlyFocusIndicatorDirective_4_5 = import15.KeyboardOnlyFocusIndicatorDirective(_el_4, parentView.injectorGet(import34.DomService, viewData.parentIndex));
    project(_el_4, 1);
    final _anchor_5 = createViewContainerAnchor();
    _appEl_5 = ViewContainer(5, 3, this, _anchor_5);
    TemplateRef _TemplateRef_5_8 = TemplateRef(_appEl_5, viewFactory_MaterialAutoSuggestInputComponent2);
    ...
    _el_6.tabIndex = -1;
    addShimC(_el_6);
    _KeyboardOnlyFocusIndicatorDirective_6_5 = import15.KeyboardOnlyFocusIndicatorDirective(_el_6, parentView.injectorGet(import34.DomService, viewData.parentIndex));
    project(_el_6, 2);
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, const import29.MultiToken('NgValidators')) && ((0 <= nodeIndex) && (nodeIndex <= 2)))) {
    ...
    if (((identical(token, import8.MaterialInputComponent) || identical(token, import36.HasDisabled)) && ((0 <= nodeIndex) && (nodeIndex <= 2)))) {
    ...
    if ((identical(token, import39.Focusable) && ((0 <= nodeIndex) && (nodeIndex <= 2)))) {
      return _Focusable_0_13;
    }
    if ((((identical(token, import14.MaterialPopupComponent) || identical(token, import40.DeferredContentAware)) || identical(token, import41.DropdownHandle)) && ((3 <= nodeIndex) && (nodeIndex <= 6)))) {
      return _MaterialPopupComponent_3_8;
    }
    if ((identical(token, import42.PopupRef) && ((3 <= nodeIndex) && (nodeIndex <= 6)))) {
...
class _ViewMaterialAutoSuggestInputComponent1 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  import4.Element _el_0;
  import43.ViewMaterialIconComponent0 _compView_0;
  ViewContainer _appEl_0;
  import44.ButtonDirectiveNgCd _ButtonDirective_0_8;
  import15.KeyboardOnlyFocusIndicatorDirective _KeyboardOnlyFocusIndicatorDirective_0_9;
  import45.MaterialIconComponent _MaterialIconComponent_0_10;
  import46.MaterialTooltipDirective _MaterialTooltipDirective_0_11;
  import47.StopPropagationDirective _StopPropagationDirective_0_12;
  ...
  dynamic get _TooltipController_0_13 {
    if ((this.__TooltipController_0_13 == null)) {
      (__TooltipController_0_13 = import48.createTooltipController(this.parentView.parentView.injectorGet(import49.TooltipController, this.parentView.viewData.parentIndex, null), this.parentView.parentView.injectorGet(import50.Disposer, this.parentView.viewData.parentIndex, null)));
    }
  ...
  @override
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    _compView_0 = import43.ViewMaterialIconComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    ...
    _ButtonDirective_0_8 = import44.ButtonDirectiveNgCd(import51.ButtonDirective(_el_0, null));
    _KeyboardOnlyFocusIndicatorDirective_0_9 = import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.injectorGet(import34.DomService, parentView.viewData.parentIndex));
    _MaterialIconComponent_0_10 = import45.MaterialIconComponent(_el_0);
    _MaterialTooltipDirective_0_11 = import46.MaterialTooltipDirective(parentView.parentView.injectorGet(import23.DomPopupSourceFactory, parentView.viewData.parentIndex), _appEl_0, _el_0, _appEl_0, _compView_0.ref, parentView.parentView.injectorGet(import4.Window, parentView.viewData.parentIndex));
    _StopPropagationDirective_0_12 = import47.StopPropagationDirective(_el_0);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import51.ButtonDirective) && (0 == nodeIndex))) {
...
class _ViewMaterialAutoSuggestInputComponent2 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  import4.Element _el_0;
  import52.ViewFocusTrapComponent0 _compView_0;
  import53.FocusTrapComponent _FocusTrapComponent_0_5;
  ...
  @override
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    _compView_0 = import52.ViewFocusTrapComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    addShimC(_el_0);
    _FocusTrapComponent_0_5 = import53.FocusTrapComponent();
    final _anchor_1 = createViewContainerAnchor();
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialAutoSuggestInputComponent3);
    _NgIf_1_9 = NgIf(_appEl_1, _TemplateRef_1_8);
    final _anchor_2 = createViewContainerAnchor();
    _appEl_2 = ViewContainer(2, 0, this, _anchor_2);
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialAutoSuggestInputComponent4);
    _NgIf_2_9 = NgIf(_appEl_2, _TemplateRef_2_8);
    final _anchor_3 = createViewContainerAnchor();
    _appEl_3 = ViewContainer(3, 0, this, _anchor_3);
    TemplateRef _TemplateRef_3_8 = TemplateRef(_appEl_3, viewFactory_MaterialAutoSuggestInputComponent5);
...
class _ViewMaterialAutoSuggestInputComponent3 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  ...
  import4.Element _el_1;
  import54.ViewMaterialSpinnerComponent0 _compView_1;
  import55.MaterialSpinnerComponent _MaterialSpinnerComponent_1_5;
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    ...
    addShimC(_el_0);
    _compView_1 = import54.ViewMaterialSpinnerComponent0(this, 1);
    _el_1 = _compView_1.rootEl;
    _el_0.append(_el_1);
    addShimC(_el_1);
    _MaterialSpinnerComponent_1_5 = import55.MaterialSpinnerComponent();
...
class _ViewMaterialAutoSuggestInputComponent5 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  import4.Element _el_0;
  import56.ViewMaterialListComponent0 _compView_0;
  import15.KeyboardOnlyFocusIndicatorDirective _KeyboardOnlyFocusIndicatorDirective_0_5;
  import57.MaterialListComponent _MaterialListComponent_0_6;
  ViewContainer _appEl_1;
  import58.NgFor _NgFor_1_9;
  var _expr_0;
  var _expr_3;
  var _expr_4;
  ...
  @override
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    _compView_0 = import56.ViewMaterialListComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    ...
    _el_0.tabIndex = -1;
    addShimC(_el_0);
    _KeyboardOnlyFocusIndicatorDirective_0_5 = import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.injectorGet(import34.DomService, parentView.parentView.viewData.parentIndex));
    _MaterialListComponent_0_6 = import57.MaterialListComponent();
    final _anchor_1 = createViewContainerAnchor();
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialAutoSuggestInputComponent6);
    _NgFor_1_9 = import58.NgFor(_appEl_1, _TemplateRef_1_8);
...
class _ViewMaterialAutoSuggestInputComponent6 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    ...
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialAutoSuggestInputComponent7);
    _NgIf_1_9 = NgIf(_appEl_1, _TemplateRef_1_8);
    final _anchor_2 = createViewContainerAnchor();
    _el_0.append(_anchor_2);
    _appEl_2 = ViewContainer(2, 0, this, _anchor_2);
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialAutoSuggestInputComponent8);
    _NgIf_2_9 = NgIf(_appEl_2, _TemplateRef_2_8);
    final _anchor_3 = createViewContainerAnchor();
    _el_0.append(_anchor_3);
    _appEl_3 = ViewContainer(3, 0, this, _anchor_3);
    TemplateRef _TemplateRef_3_8 = TemplateRef(_appEl_3, viewFactory_MaterialAutoSuggestInputComponent9);
    _NgIf_3_9 = NgIf(_appEl_3, _TemplateRef_3_8);
    final _anchor_4 = createViewContainerAnchor();
    _el_0.append(_anchor_4);
    _appEl_4 = ViewContainer(4, 0, this, _anchor_4);
    TemplateRef _TemplateRef_4_8 = TemplateRef(_appEl_4, viewFactory_MaterialAutoSuggestInputComponent10);
    _NgFor_4_9 = import58.NgFor(_appEl_4, _TemplateRef_4_8);
    init0(_el_0);
    return null;
  }
  ...
  void detectChangesInternal() {
    final import3.MaterialAutoSuggestInputComponent _ctx = ctx;
    final import59.OptionGroup<dynamic> local_suggestionGroup = locals['\$implicit'];
...
class _ViewMaterialAutoSuggestInputComponent7 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  ...
  @override
  void detectChangesInternal() {
    final import59.OptionGroup<dynamic> local_suggestionGroup = parentView.locals['\$implicit'];
...
class _ViewMaterialAutoSuggestInputComponent8 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  import4.Element _el_0;
  import60.ViewDynamicComponent0 _compView_0;
  ViewContainer _appEl_0;
  import61.DynamicComponent _DynamicComponent_0_8;
  var _expr_0;
  var _expr_1;
  var _expr_2;
  ...
  @override
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    _compView_0 = import60.ViewDynamicComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    addShimC(_el_0);
    _appEl_0 = ViewContainer(0, null, this, _el_0);
    _DynamicComponent_0_8 = import61.DynamicComponent(parentView.parentView.parentView.parentView.parentView.injectorGet(import62.SlowComponentLoader, parentView.parentView.parentView.parentView.viewData.parentIndex), _compView_0.ref, _appEl_0);
...
class _ViewMaterialAutoSuggestInputComponent9 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  import4.Element _el_0;
  import63.ViewMaterialSelectDropdownItemComponent0 _compView_0;
  import15.KeyboardOnlyFocusIndicatorDirective _KeyboardOnlyFocusIndicatorDirective_0_5;
  import64.MaterialSelectDropdownItemComponent _MaterialSelectDropdownItemComponent_0_6;
  var _expr_1;
  ...
  @override
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    _compView_0 = import63.ViewMaterialSelectDropdownItemComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    createAttr(_el_0, 'keyboardOnlyFocusIndicator', '');
    addShimC(_el_0);
    _KeyboardOnlyFocusIndicatorDirective_0_5 = import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.injectorGet(import34.DomService, parentView.parentView.parentView.parentView.viewData.parentIndex));
    _MaterialSelectDropdownItemComponent_0_6 = import64.MaterialSelectDropdownItemComponent(_el_0, null, import21.unsafeCast<ViewMaterialAutoSuggestInputComponent0>(parentView.parentView.parentView.parentView)._MaterialPopupComponent_3_8, parentView.parentView.parentView.parentView.parentView.injectorGet(import65.ActivationHandler, parentView.parentView.parentView.parentView.viewData.parentIndex, null), parentView.parentView.parentView.parentView.parentView.injectorGet(import66.IdGenerator, parentView.parentView.parentView.parentView.viewData.parentIndex, null), _compView_0.ref);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((identical(token, import67.SelectionItem) || identical(token, import68.HasRenderer)) && (0 == nodeIndex))) {
...
class _ViewMaterialAutoSuggestInputComponent10 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  import4.Element _el_0;
  import63.ViewMaterialSelectDropdownItemComponent0 _compView_0;
  import69.ActiveItemDirectiveNgCd _ActiveItemDirective_0_5;
  import15.KeyboardOnlyFocusIndicatorDirective _KeyboardOnlyFocusIndicatorDirective_0_6;
  import64.MaterialSelectDropdownItemComponent _MaterialSelectDropdownItemComponent_0_7;
  bool _expr_0;
  bool _expr_1;
  var _expr_2;
  var _expr_3;
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    _compView_0 = import63.ViewMaterialSelectDropdownItemComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = import20.interpolate2('', 'list-item', ' ', import64.MaterialSelectDropdownItemComponent.hostClass, '');
    createAttr(_el_0, 'keyboardOnlyFocusIndicator', '');
    addShimC(_el_0);
    _ActiveItemDirective_0_5 = import69.ActiveItemDirectiveNgCd(import70.ActiveItemDirective(_el_0, parentView.parentView.parentView.parentView.parentView.injectorGet(import34.DomService, parentView.parentView.parentView.parentView.viewData.parentIndex), parentView.parentView.parentView.parentView.parentView.injectorGet(import71.Modal, parentView.parentView.parentView.parentView.viewData.parentIndex, null), import21.unsafeCast<ViewMaterialAutoSuggestInputComponent0>(parentView.parentView.parentView.parentView)._PopupRef_3_11));
    _KeyboardOnlyFocusIndicatorDirective_0_6 = import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.injectorGet(import34.DomService, parentView.parentView.parentView.parentView.viewData.parentIndex));
    _MaterialSelectDropdownItemComponent_0_7 = import64.MaterialSelectDropdownItemComponent(_el_0, null, import21.unsafeCast<ViewMaterialAutoSuggestInputComponent0>(parentView.parentView.parentView.parentView)._MaterialPopupComponent_3_8, parentView.parentView.parentView.parentView.parentView.injectorGet(import65.ActivationHandler, parentView.parentView.parentView.parentView.viewData.parentIndex, null), parentView.parentView.parentView.parentView.parentView.injectorGet(import66.IdGenerator, parentView.parentView.parentView.parentView.viewData.parentIndex, null), _compView_0.ref);
...
class _ViewMaterialAutoSuggestInputComponentHost0 extends AppView<import3.MaterialAutoSuggestInputComponent> {
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent> build() {
    ...
    _MaterialAutoSuggestInputComponent_0_5 = import3.MaterialAutoSuggestInputComponent(null, this.injectorGet(import66.IdGenerator, viewData.parentIndex, null), this.injectorGet(import32.PopupSizeProvider, viewData.parentIndex, null));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((((((((((identical(token, import3.MaterialAutoSuggestInputComponent) || identical(token, import36.HasDisabled)) || identical(token, import68.HasRenderer)) || identical(token, import67.SelectionContainer)) || identical(token, import72.HighlightProvider)) || identical(token, import41.DropdownHandle)) || identical(token, import68.HasComponentRenderer)) || identical(token, import73.HasFactoryRenderer)) || identical(token, import39.Focusable)) || identical(token, import32.PopupSizeProvider)) && (0 == nodeIndex))) {
...
AppView<import3.MaterialAutoSuggestInputComponent> viewFactory_MaterialAutoSuggestInputComponentHost0(AppView<dynamic> parentView, int parentIndex) {
