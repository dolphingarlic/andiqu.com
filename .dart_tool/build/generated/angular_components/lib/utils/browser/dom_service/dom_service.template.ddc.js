define(['dart_sdk', 'packages/angular/di.template', 'packages/angular_components/utils/async/async.template', 'packages/angular_components/utils/disposer/disposable_callback.template', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, di, async, disposable_callback, disposer) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["dom_service.template.dart"],"names":[],"mappings":";;;;;;;;;;;;MAoBI,4DAAQ;YAAG;;;;;AAEb,kBAAI,4DAAQ,GAAE;AACZ;;AAEF,mEAAW;AAEX,IAAM,2BAAa;AACnB,IAAM,4CAAa;AACnB,IAAM,6DAAa;AACnB,IAAM,kDAAa;EACrB","file":"dom_service.template.ddc.js"}');
  // Exports:
  return {
