define(['dart_sdk', 'packages/angular_components/material_list/material_list_size', 'packages/angular_components/utils/angular/properties/properties', 'packages/angular_components/model/ui/accepts_width'], function(dart_sdk, material_list_size, properties, accepts_width) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_list.dart"],"names":[],"mappings":";;;;;;;;;;;;;IA4CS;;;;;;cAIG,GAAG;AACX,SAAG,GAAG,6CAAM,CAAC,GAAG;AAChB,qBAAQ,WAAJ,GAAG,SAAI,mBAAS,WAAJ,GAAG,QAAG,kDAAgB,OAAO,SAAO,KAAE;AACpD,iBAAI,GAAG,kDAAgB,OAAO,wBAAC,GAAG;;IAEtC;;;IATO,UAAI,GAAG,kDAAgB,KAAK;EAUrC","file":"material_list.ddc.js"}');
  // Exports:
  return {
