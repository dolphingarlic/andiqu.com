...
import 'package:angular/src/core/linker/dynamic_component_loader.dart' as import16;
import '../material_tree_root.dart' as import17;
import 'package:angular_components/src/material_tree/group/material_tree_group_flat_radio.scss.css.shim.dart' as import18;
import '../../../material_radio/material_radio_group.template.dart' as import19;
...
import 'package:angular_components/src/material_tree/group/material_tree_group_flat_check.scss.css.shim.dart' as import26;
import '../../../material_checkbox/material_checkbox.template.dart' as import27;
...
class _ViewMaterialTreeGroupFlatListComponent2 extends AppView<import2.MaterialTreeGroupFlatListComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatListComponent> build() {
    ...
    _DynamicComponent_0_8 = import15.DynamicComponent(parentView.parentView.injectorGet(import16.SlowComponentLoader, parentView.viewData.parentIndex), _compView_0.ref, _appEl_0);
...
class _ViewMaterialTreeGroupFlatListComponentHost0 extends AppView<import2.MaterialTreeGroupFlatListComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatListComponent> build() {
    ...
    _MaterialTreeGroupFlatListComponent_0_5 = import2.MaterialTreeGroupFlatListComponent(this.injectorGet(import17.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref);
...
final List<dynamic> styles$MaterialTreeGroupFlatRadioComponent = [import18.styles];

class ViewMaterialTreeGroupFlatRadioComponent0 extends AppView<import2.MaterialTreeGroupFlatRadioComponent> {
  import8.Element _el_0;
  import19.ViewMaterialRadioGroupComponent0 _compView_0;
  import20.MaterialRadioGroupComponent _MaterialRadioGroupComponent_0_5;
  ViewContainer _appEl_1;
  ...
  ComponentRef<import2.MaterialTreeGroupFlatRadioComponent> build() {
    final _rootEl = rootEl;
    final import8.HtmlElement parentRenderNode = initViewRoot(_rootEl);
    _compView_0 = import19.ViewMaterialRadioGroupComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    parentRenderNode.append(_el_0);
    addShimC(_el_0);
    _MaterialRadioGroupComponent_0_5 = import20.MaterialRadioGroupComponent(parentView.injectorGet(import21.NgZone, viewData.parentIndex), null);
    final _anchor_1 = createViewContainerAnchor();
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
...
class _ViewMaterialTreeGroupFlatRadioComponent1 extends AppView<import2.MaterialTreeGroupFlatRadioComponent> {
  ...
  @override
  ComponentRef<import2.MaterialTreeGroupFlatRadioComponent> build() {
    _compView_0 = import22.ViewMaterialRadioComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = import9.interpolate2('', 'material-tree-option tree-selection-state', ' ', import23.MaterialRadioComponent.hostClass, '');
    createAttr(_el_0, 'role', 'option');
    addShimC(_el_0);
    _MaterialRadioComponent_0_5 = import23.MaterialRadioComponent(_el_0, _compView_0.ref, import10.unsafeCast<ViewMaterialTreeGroupFlatRadioComponent0>(parentView)._MaterialRadioGroupComponent_0_5, null, 'option');
    final _anchor_1 = createViewContainerAnchor();
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import24.HasDisabled) && ((0 <= nodeIndex) && (nodeIndex <= 2)))) {
...
class _ViewMaterialTreeGroupFlatRadioComponent2 extends AppView<import2.MaterialTreeGroupFlatRadioComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatRadioComponent> build() {
    ...
    addShimC(_el_0);
    _appEl_0 = ViewContainer(0, null, this, _el_0);
    _DynamicComponent_0_8 = import15.DynamicComponent(parentView.parentView.parentView.injectorGet(import16.SlowComponentLoader, parentView.parentView.viewData.parentIndex), _compView_0.ref, _appEl_0);
    _compView_0.create(_DynamicComponent_0_8, []);
    init0(_appEl_0);
    return null;
  }
...
class _ViewMaterialTreeGroupFlatRadioComponentHost0 extends AppView<import2.MaterialTreeGroupFlatRadioComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatRadioComponent> build() {
    ...
    rootEl = _compView_0.rootEl;
    _MaterialTreeGroupFlatRadioComponent_0_5 = import2.MaterialTreeGroupFlatRadioComponent(this.injectorGet(import17.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref, this.injectorGet(import25.DropdownHandle, viewData.parentIndex, null));
...
final List<dynamic> styles$MaterialTreeGroupFlatCheckComponent = [import26.styles];
...
class _ViewMaterialTreeGroupFlatCheckComponent1 extends AppView<import2.MaterialTreeGroupFlatCheckComponent> {
  import8.Element _el_0;
  import27.ViewMaterialCheckboxComponent0 _compView_0;
  import28.MaterialCheckboxComponent _MaterialCheckboxComponent_0_5;
  ViewContainer _appEl_1;
  NgIf _NgIf_1_9;
  ViewContainer _appEl_2;
  NgIf _NgIf_2_9;
  ...
  @override
  ComponentRef<import2.MaterialTreeGroupFlatCheckComponent> build() {
    _compView_0 = import27.ViewMaterialCheckboxComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = import9.interpolate2('', 'material-tree-option tree-selection-state', ' ', import28.MaterialCheckboxComponent.hostClass, '');
    createAttr(_el_0, 'role', 'option');
    addShimC(_el_0);
    _MaterialCheckboxComponent_0_5 = import28.MaterialCheckboxComponent(_el_0, _compView_0.ref, null, null, 'option');
    final _anchor_1 = createViewContainerAnchor();
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
...
class _ViewMaterialTreeGroupFlatCheckComponentHost0 extends AppView<import2.MaterialTreeGroupFlatCheckComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatCheckComponent> build() {
    ...
    rootEl = _compView_0.rootEl;
    _MaterialTreeGroupFlatCheckComponent_0_5 = import2.MaterialTreeGroupFlatCheckComponent(this.injectorGet(import17.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref, this.injectorGet(import25.DropdownHandle, viewData.parentIndex, null));
