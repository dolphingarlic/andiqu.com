...
import '../../material_icon/material_icon.dart' as import35;
import 'material_tree_filter.template.dart' as import36;
import 'material_tree_filter.dart' as import37;
import 'material_tree_root.dart' as import38;
import 'material_tree_impl.template.dart' as import39;
import 'material_tree_impl.dart' as import40;
...
class ViewMaterialTreeDropdownComponent0 extends AppView<import2.MaterialTreeDropdownComponent> {
  ...
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    ...
    addShimC(_el_0);
    _KeyboardOnlyFocusIndicatorDirective_0_5 = import4.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.injectorGet(import17.DomService, viewData.parentIndex));
    _PopupSourceDirective_0_6 = import5.PopupSourceDirective(parentView.injectorGet(import18.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import19.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import20.Focusable, viewData.parentIndex, null), null);
    ...
    _MaterialPopupComponent_4_8 = import9.MaterialPopupComponent(parentView.injectorGet(import22.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import9.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import23.NgZone, viewData.parentIndex), parentView.injectorGet(import24.OverlayService, viewData.parentIndex), parentView.injectorGet(import25.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import26.OpaqueToken<List<import28.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import26.OpaqueToken('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import29.PopupSizeProvider, viewData.parentIndex, null), _compView_4.ref, _appEl_4, ElementRef(_el_4));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import9.MaterialPopupComponent) || identical(token, import31.DeferredContentAware)) || identical(token, import32.DropdownHandle)) && ((4 <= nodeIndex) && (nodeIndex <= 7)))) {
      return _MaterialPopupComponent_4_8;
    }
    if ((identical(token, import22.PopupHierarchy) && ((4 <= nodeIndex) && (nodeIndex <= 7)))) {
      return _PopupHierarchy_4_11;
    }
    if ((identical(token, import33.PopupRef) && ((4 <= nodeIndex) && (nodeIndex <= 7)))) {
...
class _ViewMaterialTreeDropdownComponent2 extends AppView<import2.MaterialTreeDropdownComponent> {
  ...
  import35.MaterialIconComponent _MaterialIconComponent_0_5;
  ...
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    ...
    addShimC(_el_0);
    _MaterialIconComponent_0_5 = import35.MaterialIconComponent(_el_0);
...
class _ViewMaterialTreeDropdownComponent3 extends AppView<import2.MaterialTreeDropdownComponent> {
  ...
  import37.MaterialTreeFilterComponent _MaterialTreeFilterComponent_0_5;
  String _expr_0;
  var _expr_1;
  ...
  @override
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    _compView_0 = import36.ViewMaterialTreeFilterComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    addShimC(_el_0);
    _MaterialTreeFilterComponent_0_5 = import37.MaterialTreeFilterComponent(parentView.parentView.injectorGet(import38.MaterialTreeRoot, parentView.viewData.parentIndex, null));
...
class _ViewMaterialTreeDropdownComponent5 extends AppView<import2.MaterialTreeDropdownComponent> {
  ...
  import40.MaterialTreeComponent _MaterialTreeComponent_0_5;
  bool _expr_0;
  var _expr_1;
  var _expr_2;
  var _expr_3;
  ...
  @override
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    _compView_0 = import39.ViewMaterialTreeComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    addShimC(_el_0);
    _MaterialTreeComponent_0_5 = import40.MaterialTreeComponent(parentView.parentView.injectorGet(import38.MaterialTreeRoot, parentView.viewData.parentIndex, null), null);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import38.MaterialTreeRoot) && (0 == nodeIndex))) {
...
class _ViewMaterialTreeDropdownComponentHost0 extends AppView<import2.MaterialTreeDropdownComponent> {
  ...
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    ...
    _MaterialTreeDropdownComponent_0_5 = import2.MaterialTreeDropdownComponent(this.injectorGet(import17.DomService, viewData.parentIndex));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import2.MaterialTreeDropdownComponent) || identical(token, import20.Focusable)) || identical(token, import38.MaterialTreeRoot)) && (0 == nodeIndex))) {
