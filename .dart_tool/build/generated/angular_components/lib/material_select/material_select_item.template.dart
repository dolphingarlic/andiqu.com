...
class ViewMaterialSelectItemComponent0 extends AppView<import2.MaterialSelectItemComponent> {
  ...
  ComponentRef<import2.MaterialSelectItemComponent> build() {
    ...
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialSelectItemComponent2);
    ...
    TemplateRef _TemplateRef_4_8 = TemplateRef(_appEl_4, viewFactory_MaterialSelectItemComponent6);
    ...
    TemplateRef _TemplateRef_6_8 = TemplateRef(_appEl_6, viewFactory_MaterialSelectItemComponent7);
...
class _ViewMaterialSelectItemComponent2 extends AppView<import2.MaterialSelectItemComponent> {
  ...
  ComponentRef<import2.MaterialSelectItemComponent> build() {
    ...
    TemplateRef _TemplateRef_0_8 = TemplateRef(_appEl_0, viewFactory_MaterialSelectItemComponent3);
    _NgIf_0_9 = NgIf(_appEl_0, _TemplateRef_0_8);
    import3.Text _text_1 = import3.Text('  ');
    final _anchor_2 = createViewContainerAnchor();
    _appEl_2 = ViewContainer(2, null, this, _anchor_2);
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialSelectItemComponent4);
    _NgIf_2_9 = NgIf(_appEl_2, _TemplateRef_2_8);
...
class _ViewMaterialSelectItemComponent4 extends AppView<import2.MaterialSelectItemComponent> {
  ...
  ComponentRef<import2.MaterialSelectItemComponent> build() {
    ...
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialSelectItemComponent5);
...
class _ViewMaterialSelectItemComponentHost0 extends AppView<import2.MaterialSelectItemComponent> {
  ...
  ComponentRef<import2.MaterialSelectItemComponent> build() {
    ...
    _MaterialSelectItemComponent_0_5 = import2.MaterialSelectItemComponent(rootEl, this.injectorGet(import21.DropdownHandle, viewData.parentIndex, null), this.injectorGet(import22.ActivationHandler, viewData.parentIndex, null), _compView_0.ref, null);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import23.SelectionItem) || identical(token, import15.HasDisabled)) || identical(token, import24.HasRenderer)) && (0 == nodeIndex))) {
...
AppView<import2.MaterialSelectItemComponent> viewFactory_MaterialSelectItemComponentHost0(AppView<dynamic> parentView, int parentIndex) {
