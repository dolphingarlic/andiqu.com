define(['dart_sdk', 'packages/angular_components/model/selection/selection_model', 'packages/angular_forms/src/directives', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_select/material_dropdown_select'], function(dart_sdk, selection_model, directives, change_detection, material_dropdown_select) {
  'use strict';
  ...
  (material_select__material_dropdown_select_accessor.DropdownSelectValueAccessor.new = function(select) {
    ...
    material_select__material_dropdown_select_accessor.DropdownSelectValueAccessor.__proto__.new.call(this, select, model__selection__selection_model.SelectionModel.single());
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_dropdown_select_accessor.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;IA0GuB;;;;;;IAEhB;;;;;;;AAMH,oBAAI,gBAAW,GAAE;AACjB,sBAAW,GAAG;AACd,YAAO,aAAO,UAAU,IAAI,yBACxB;AACJ,mBAAO,UAAU,GAAG,mBAAc;IACpC;sBAGuB,QAAQ;AAC7B,wBAAY,GAAG,aAAO,cAAc,OAAO,CAAC,QAAC,CAAC;AAE5C,0BAAY,OAAO;AACnB,gBAAQ;;IAEZ;;AAIE,gCAAY;;IACd;sBAGuB,UAAe,GAAG;;6GA1BK,cAAmB;IAH9C,kBAAY;IAC1B,iBAAW,GAAG;IAEkB,aAAO;IAAO,qBAAc,GAAd,cAAc;EAAC;;;;;;;;;;;;;;;;;;;;qBAhF5C,QAAQ;AAC5B,gCAAoB,GAAG,mBAAc,iBAAiB,OAAO,CAAC,QAAC,CAAC;AAC9D,YAAI,QAAQ,AAAC,mBAAc,eAAe,IAAI,kBACtC,mBAAc,eAAe,UAAQ,IACvC;kBACA,mBAAc,eAAe;;;AACnC,gBAAQ,CAAC,KAAK;;IAElB;eAGgB,QAAQ;AACtB,mCAAwB;AACxB,UAAI,QAAQ,IAAI,MAAM;AACpB,2BAAc,OAAO,CAAC,QAAQ;aACzB;AACL,2BAAc,MAAM;;IAExB;;AAIE,wCAAoB;;AACpB,uBAAiB;IACnB;;iGA5B4B,MAAsC;IAD/C,0BAAoB;AAEjC,4GAAM,MAAM,EAAE,uDAAqB;EAAG;;;;;;;;;;;;;IA2CxC;;;;;;qBAMkB,QAAQ;AAC5B,8BAAmB,GAAG,mBAAc,iBAAiB,OAAO,CAAC,QAAC,CAAC;AAC7D,gBAAQ;kBAAC,mBAAc,eAAe;;;;IAE1C;eAGgB,QAAQ;AACtB,mCAAwB;AACxB,yBAAc,MAAM;AACpB,UAAI,QAAQ,IAAI,MAAM;AACtB,4BAAO,QAAQ,qBAAc;AAC7B,eAAW,8BAAS,QAAQ,GAAE;AAC5B,2BAAc,OAAO,CAAC,KAAK;;IAE/B;;AAIE,sCAAmB;;AACnB,uBAAiB;IACnB;;sGAzBiC,MAAsC;IAFnE,yBAAmB;AAGjB,iHAAM,MAAM,EAAE,yDAAmB;EAAG","file":"material_dropdown_select_accessor.ddc.js"}');
  // Exports:
  return {
