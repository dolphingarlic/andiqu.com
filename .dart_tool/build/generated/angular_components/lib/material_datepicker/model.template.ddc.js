define(['dart_sdk', 'packages/angular_components/material_datepicker/model', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_datepicker/comparison.template', 'packages/angular/di.template', 'packages/angular_components/model/observable/observable.template', 'packages/angular_components/material_datepicker/range.template'], function(dart_sdk, model, change_detection, comparison, di, observable, range) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["model.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;MAiBI,8CAAQ;YAAG;;;;;AAEb,kBAAI,8CAAQ,GAAE;AACZ;;AAEF,qDAAW;AAEX,IAAO,kCAAe,CAAC,yDAAe,EAAE,kBAAM,8CAAe;AAC7D,IAAM,wDAAa;AACnB,IAAM,wDAAa;AACnB,IAAM,2BAAa;AACnB,IAAM,sDAAa;AACnB,IAAM,mDAAa;EACrB","file":"model.template.ddc.js"}');
  // Exports:
  return {
