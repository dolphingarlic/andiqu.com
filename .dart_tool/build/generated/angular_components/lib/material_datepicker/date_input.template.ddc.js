define(['dart_sdk', 'packages/angular_components/material_datepicker/calendar.template', 'packages/angular_components/material_datepicker/module.template', 'packages/angular/angular.template', 'packages/angular_components/material_input/material_input.template', 'packages/angular_components/model/date/date.template', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, calendar, module, angular, material_input, date, disposer) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["date_input.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;MAuBI,mDAAQ;YAAG;;;;;AAEb,kBAAI,mDAAQ,GAAE;AACZ;;AAEF,0DAAW;AAEX,IAAM,sDAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,0CAAa;AACnB,IAAM,kDAAa;EACrB","file":"date_input.template.ddc.js"}');
  // Exports:
  return {
