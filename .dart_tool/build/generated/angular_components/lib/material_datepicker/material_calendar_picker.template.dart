...
class _ViewMaterialCalendarPickerComponentHost0 extends AppView<import2.MaterialCalendarPickerComponent> {
  ...
  ComponentRef<import2.MaterialCalendarPickerComponent> build() {
    ...
    _MaterialCalendarPickerComponent_0_5 = import2.MaterialCalendarPickerComponent(this.injectorGet(const import14.OpaqueToken('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null), this.injectorGet(import15.Clock, viewData.parentIndex), null);
