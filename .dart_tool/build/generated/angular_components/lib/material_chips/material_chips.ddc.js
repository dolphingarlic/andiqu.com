define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/model/ui/has_renderer', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, disposer, selection_model, has_renderer, change_detection) {
  ...
  (material_chips__material_chips.MaterialChipsComponent.new = function(changeDetector) {
    ...
    this[removable] = true;
    this[_selectionModel] = const$ || (const$ = dart.const(model__selection__selection_model.SelectionModel.empty()));
  ...
  dart.setGetterSignature(material_chips__material_chips.MaterialChipsComponent, () => ({
    ...
    selectionModel: model__selection__selection_model.SelectionModel,
    itemRenderer: dart.fnType(core.String, [dart.dynamic]),
    selectedItems: core.Iterable
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_chips.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;IAyBO;;;;;;uBASc,KAAoB;AACrC,2BAAe,GAAG,KAAK;AACvB,MACE,AAAE,uBAAO;MACT,AAAE,6BAAa,oDAAC,qBAAe,iBAAiB,OAAO,CAAC,QAAC,CAAC;AACxD,6BAAe,aAAa;;IAElC;;YAEqC,sBAAe;;qBAanC,KAAkB;AACjC,yBAAa,GAAG,KAAK;IACvB;;YAIiC,oBAAa;;;YAEhB,oBAAc,eAAe;;gCAGxB,KAAY;YAAK,MAAK,gCAAL,KAAK;IAAY;;AAMnE,qBAAS,QAAQ;IACnB;;;IArDe,eAAS,OAAG,wCAAc;IAIpC,eAAS,GAAG;IAKF,qBAAe,GAAG,+BAAM,sDAAoB;IA8B9C,mBAAa,GAAG,qGAAoB;IASrB,qBAAe;EAAC","file":"material_chips.ddc.js"}');
  // Exports:
  return {
