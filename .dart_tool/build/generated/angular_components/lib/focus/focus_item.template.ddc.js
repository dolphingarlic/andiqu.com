define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/directive_change_detector', 'packages/angular_components/focus/focus_item', 'packages/angular/angular.template', 'packages/angular_components/focus/focus.template'], function(dart_sdk, modules, directive_change_detector, focus_item, angular, focus) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["focus_item.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;IAoBmC;;;;;;sBAGV,IAAqB,EAAE,EAAkB;AAC9D,UAAK,aAAc,IAAI,QAAQ,KAAI;AACnC,UAAI,UAAU,EAAE;AACd,cAAK,AAAU,aAAQ,KAAK,IAAE,OAAO;AACnC,sBAAO,CAAC,EAAE,EAAE,QAAQ,aAAQ,KAAK,gCAAb,aAAQ,KAAK;;;AAGrC,UAAM,YAAY,aAAQ,SAAS;AACnC,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,oBAAO,CAAC,EAAE,EAAE,YAAY,SAAS,gCAAT,SAAS;AACjC,qBAAO,GAAG,SAAS;;IAEvB;;sEAbuB,QAAa;IADhC,aAAO;IACiB,eAAQ,GAAR,QAAQ;;EAAC;;;;;;;;;MAgBnC,qCAAQ;YAAG;;;;;AAEb,kBAAI,qCAAQ,GAAE;AACZ;;AAEF,4CAAW;AAEX,IAAM,gCAAa;AACnB,IAAM,qCAAa;EACrB","file":"focus_item.template.ddc.js"}');
  // Exports:
  return {
