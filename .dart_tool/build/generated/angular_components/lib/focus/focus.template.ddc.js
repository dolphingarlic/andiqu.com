define(['dart_sdk', 'packages/angular_components/focus/focus_interface.template', 'packages/angular/angular.template', 'packages/angular_components/laminate/components/modal/modal.template', 'packages/angular_components/laminate/popup/popup.template', 'packages/angular_components/utils/browser/dom_service/dom_service.template', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, focus_interface, angular, modal, popup, dom_service, disposer) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["focus.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;MAuBI,gCAAQ;YAAG;;;;;AAEb,kBAAI,gCAAQ,GAAE;AACZ;;AAEF,uCAAW;AAEX,IAAM,+CAAa;AACnB,IAAM,+CAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,2DAAa;AACnB,IAAM,+CAAa;AACnB,IAAM,iEAAa;AACnB,IAAM,kDAAa;EACrB","file":"focus.template.ddc.js"}');
  // Exports:
  return {
